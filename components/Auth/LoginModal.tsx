  ...
  const handleSignup: MouseEventHandler<HTMLButtonElement> = async (e) => {
    ...
    if (password.length < 8) {
      ...
      if (password === confirmPassword) {
        ...
        setPassword("");
        setConfirmPassword("");
        const cached_likes = sessionStorage.getItem("likes")
          ? JSON.parse(sessionStorage.getItem("likes") as string)
          : [];
        const cached_dislikes = sessionStorage.getItem("dislikes")
          ? JSON.parse(sessionStorage.getItem("dislikes") as string)
          : [];
